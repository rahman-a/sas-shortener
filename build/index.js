...
import { shortenUrl, updateUrlClicks, getAllUrls, getOneUrl, deleteUrl, filterUrls, getUser, } from './controllers/crud.js';
...
// serve static files
app.use('/api/assets', express.static(path.join(process.cwd(), 'server', 'assets')));
// authentication
...
app.use(isAuth);
// shorten a new url
app.post('/api/shorten', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
...
// get all urls
app.get('/api/urls', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, createdAt, clicks, page, sort, urls, error_3;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.query, createdAt = _a.createdAt, clicks = _a.clicks, page = _a.page;
                sort = {};
                if (createdAt)
...
app.get('/api/urls/filter', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var urls, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
// delete a url
app.delete('/api/:short', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
...
app.get('/:short', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var short, url;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                ...
                return [2 /*return*/];
            case 2: return [4 /*yield*/, updateUrlClicks(short)];
            case 3:
                _a.sent();
